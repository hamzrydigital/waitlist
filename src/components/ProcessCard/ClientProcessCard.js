...
export function ClientProcessCard(props) {
  ...
  switch (variant) {
    case "fill":
      variantStyle.container = "bg-[#108239] md:w-[657px]";
      variantStyle.tagline = "text-white";
      variantStyle.description = "text-white";
      variantStyle.title = "text-white ";
      break;
    case "stroke":
      variantStyle.container = "border-[#108239] border-4 border md:w-[687px]";
...
ClientProcessCard.defaultProps = {
  img: "",
  variant: "fill",
  type: "client",
  title: "Add a title",
